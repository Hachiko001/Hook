// NotificationArea.cpp : Defines the entry point for the application.
//
...
//Using CreateGUI from menu Tools to generate GUID
	...
	_In_ int       nCmdShow)
{
	...
	LoadStringW(hInstance, IDC_NOTIFICATIONAREA, szWindowClass, MAX_LOADSTRING);
	...
	HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_NOTIFICATIONAREA));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_NOTIFICATIONAREA));
	wcex.hCursor = LoadCursor(nullptr, IDC_ARROW);
	wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
	wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_NOTIFICATIONAREA);
